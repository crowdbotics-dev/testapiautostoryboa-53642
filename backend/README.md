...
## Project Structure
    ...
    ├── testapiautostoryboa_53642  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_53642`
...
2. Clone this repo and `cd testapiautostoryboa_53642`
